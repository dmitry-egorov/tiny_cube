...
namespace Plugins.Lanski.Subjective
{
    public abstract class SSystem: ISystem
    {
        ...
        public void Do(Action a) 
            => SManager.Register(Reflect.CallingMethodName(), a, new TypeMask(), new TypeMask());
        ...
        public static bool try_get<TC>(out TC c) where TC : SubjectComponent => subject.try_get(out c);
        public static TC add<TC>() where TC : SubjectComponent => subject.add<TC>();
        public static TC get_or_add<TC>() where TC : SubjectComponent => subject.get_or_add<TC>();
